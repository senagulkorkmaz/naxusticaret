  ...
  return (
    <div>
      ...
      <Button secondary size="big" as={NavLink} to="/signup">
        SignUp <Icon name="chevron circle right" />
      </Button>
      <Button secondary size="big" as={NavLink} to="/loginscreen">
        Login <Icon name="chevron circle right" />
      </Button>
      <br />
      <br />
      ...
      <Grid columns="three" divided color="red">
        <Grid.Row>
          ...
          <Grid.Column color="purple">
            <Button color="purple">
              <Header as="h3">?</Header>{" "}
              <h5>Naxus CLUB sıkça sorulan sorular</h5>
            </Button>
          </Grid.Column>
        </Grid.Row>
      </Grid>
      ...
      <Segment style={containerstyle}>
        ...
        ürün yelpazesi ile alanında lider olan Naxus, Naxus Club Kart ile
        kullanıcılara çok sayıda avantaj sunuyor. Kişiye özel kampanyalar,
        indirim kuponu, hoş geldin kuponu, faturasız yaşam, uzatılmış ürün iade
        süresi ve birçok hediye, Naxus Club Kart üyelerini bekliyor. Yeni üye
        olanlara 50 TL’lik hoş geldin kuponu, her kişiye doğum gününde 50 TL’lik
        doğum günü kuponu ve daha pek çok ayrıcalık için Naxus Club Kart
        ailesine kolayca dahil olabilir, harcadıkça indirim ve hediye
        kazanabilirsiniz.
        <Divider section />
        <Header as="h3">Naxus CLUB Üyeliği</Header>
        <p>
          Naxus CLUB ailesine dahil olmak ve sayısız avantajdan yararlanmak için
          mağaza personelimizin desteği ile, dijital olarak naxus.com.tr veya
          Naxus mobil uygulamasından üyelik oluşturabilirsiniz. Bu sayede
        ...
        <p>
          ...
          gereken Naxus mobil uygulamasını akıllı telefonunuza yüklemek veya web
          sitemize Hesabım alanından giriş yaparak Naxus Club üyelik
        ...
        <Divider section />
        <Header as="h1">Naxus CLUB Uzatılmış Ürün İade Süresi</Header>
        ...
        yönelik satın alma geçmişinize, mağazalardan, naxus.com.tr adresinden,
        NAxus mobil uygulamasından veya çağrı merkezimizden ulaşabilirsiniz.
        Ürün iade ve değişim gibi süreçlerin yürütülmesinde büyük kolaylık
        sağlayan bu yöntem sayesinde basılı faturalarınızı saklama derdinden
        kurtulursunuz.
      </Segment>
    </div>
  );
