  ...
  return (
    <div>
      ...
      <List style={containerstyle} size="large">
        ...
        <List.Item>
          <Icon name="arrow right" size="large" color="purple" />
          Naxus tarafından düzenlenen tüm kampanyalar tüketicilere yöneliktir.
        </List.Item>
        <List.Item>
          <Icon name="arrow right" size="large" color="purple" />
        ...
        <List.Item>
          <Icon name="arrow right" size="large" color="purple" />
          Naxus; kampanyalar sırasında oluşabilecek öngörülemeyen değişiklikler
          nedeniyle ürün , fiyat değişimi yapma ve kampanyayı son erdirme
          hakkını saklı tutar.
        </List.Item>
      </List>
      <br />
      <Segment style={containerstyle}>
        ...
        Naxus kampanya sayfasını güncel olarak takip ederek tüm ihtiyaçlarınız
        için pek çok fırsata göz atabilirsiniz. Elektronik cihazlardan
        elektrikli ev aletlerine, bilgisayarlardan cep telefonlarına kadar
        birçok üründe, etkileyici fiyatlar ve ürün seçeneklerine kampanyalar
        sayesinde ulaşmanız mümkün. Naxus'un cazip fiyat avantajları ve binlerce
        üründe gerçekleştirdiği indirimler, evinizin rahatlığında kolayca
        alışveriş yapabilmenize olanak tanıyor. NAxus'un müşterileri için özenle
        hazırladığı kampanyaların yer aldığı sayfada birçok ürün çeşidini bir
        arada bulabilir, seçenekleri değerlendirebilirsiniz.
        <Divider section />
        <Header as="h2">
        ...
        <p>
          ...
          fırsatlar yaratıyor. Naxus, düzenlemiş olduğu kampanya seçenekleri
          kadar satın almış olduğunuz ürünlerin birçoğunda aksesuar olarak
          kullanılan ürünlerde de ekstra indirim fırsatları sunuyor.
        </p>
        <p>
        ...
        <p>
          Güncel olarak takip edeceğiniz Naxus indirim kampanyaları, bütçenize
          dost alışveriş fırsatlarını kapınıza kadar getiriyor. Dünyaca ünlü
          markaların yer aldığı kampanya kapsamında alışveriş zevkini güvenle
          yaşayabileceğiniz On-line satış hizmeti Naxus tarafından sağlanıyor.
          Türkiye'nin dört bir yanından kolaylıkla sipariş verebileceğiniz ve
          üst düzey güvenlik seviyesinde alışveriş yapabileceğiniz naxus.com.tr
          benzersiz indirim ve kusursuz hizmet anlayışıyla sizi karşılıyor.
        </p>
        <Divider section />
        <Header as="h2">
        ...
        <p>
          ...
          etmeyi gerektiriyor. Naxus, telefon kampanyaları düzenleyerek en hızlı
          tüketim ürünlerinden biri olan cep telefonlarının, en avantajlı ve en
          karlı biçimde müşterilerine ulaştırılmasını sağlıyor. Telefon
          ...
          sunuluyor. Naxus; iş, eğlence ve oyun tutkunlarına özel bilgisayar ve
          laptop modellerini, elektronik kampanyalar düzenleyerek eşsiz indirim
          seçenekleriyle satışa sunuyor. Rakipsiz fiyatlar ile sahip
          olabileceğiniz bilgisayar modelleri, düzenli olarak takip edeceğiniz
          Naxus elektronik kampanyalar sayfasında geniş bir ürün gamıyla yer
          buluyor.
        </p>
      </Segment>
    </div>
